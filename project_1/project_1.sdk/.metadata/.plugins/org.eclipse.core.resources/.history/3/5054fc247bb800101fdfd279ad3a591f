...
int main (void) {
	...
	inputa = (u64 *) DDR_MEMORY + 0x00001000;
	HardwareOutput = (u64 *) inputa + (sizeof(u64)*32);
	SoftwareOutput = (u64 *) HardwareOutput + (sizeof(u64)*32);
    ...
    MoveDataDMA64(inputa, bram_a_destination, inputnum);
    XTime_GetTime(&t1);
    ...
    int outputnum = 17;
    XTime_GetTime(&t2);
    MoveDataDMA64(bram_out0_destination, HardwareOutput, outputnum) ;
    XTime_GetTime(&t3);
    //fourbyfour_sw(inputa, SoftwareOutput, 32);
    XTime_GetTime(&t4);
